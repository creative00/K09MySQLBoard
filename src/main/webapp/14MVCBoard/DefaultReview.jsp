...
<body>
	<div id="header">
		<%@ include file="../WWW/00Main/inc/top.jsp" %>
	</div>
	<!-- <div id="nav">
	</div> -->
</body>
<body>
	...
	<form name="myform" action="../WWW/01Login/Join_Action.jsp" method="POST" onsubmit="return formValidate();">
        <style>
        *{font-family: Verdana, Geneva, Tahoma, sans-serif;  margin: 0px auto;}
        ...
        <table class="userTable">
            ...
            <tr>
                ...
                <td class="userVal">
                    <input type="text" name="email_id" value="" class="userInput w100" />
        ...
        <div id="nav">
	     ...
	     <!-- 하단 아이콘 바 -->
	<div id="link">
		<%@ include file="../WWW/00Main/inc/link.jsp" %>
	</div>
   	
    <div id="footer">
		<%@ include file="../WWW/00Main/inc/footer.jsp" %>
